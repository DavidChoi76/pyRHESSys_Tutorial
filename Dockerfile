...
#packageUrl<- "https://cran.r-project.org/src/contrib/Archive/rgrass7/rgrass7_0.1-12.tar.gz"
RUN Rscript -e "install.packages("rgrass7_0.1-12.tar.gz", repos=NULL, type="source")"
